...
salt = b""
password = hashlib.pbkdf2_hmac("sha256", b"password123", salt, 600_000).hex()
...
def getVault():
    ...
    # Condensed version
    print(json.loads(unpad(AES.new(key, AES.MODE_CBC, iv).decrypt(bytes.fromhex(res.json()["vault"])), AES.block_size).decode().replace("'", '"')))
